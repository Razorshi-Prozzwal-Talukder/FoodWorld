  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ URL::to('/admin_dashboard') }}"><h1>HOME</h1></a>
      </div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">FooD WorlD</p>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ URL('/allmanager') }}">
                <i class="mdi mdi-gauge menu-icon"></i>
                <span class="menu-title">All Manager</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ URL('/addmanager') }}">
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="float-right">
                <a href="#">Razorshi P.T</a> &copy; 2018
            </span>
          </div>
        </footer>
        <!-- partial -->
